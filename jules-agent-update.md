...
- Create a `.env.local` file in the project root with the Firebase configuration keys.
- Populate it with the following values (replace placeholders as needed):
...
- Ensure these variables are also set in the Vercel dashboard under **Environment Variables** for all environments.

---
## RBAC Users Snapshot (2026-06-08 05:09 UTC+8)

Top‑level keys in Realtime DB: account_data, cron_heartbeat, groups, invoices, system_triggers, users

| UID | Email | Role |
|-----|-------|------|
| 1Z4vYrE9ZQUvFwmwWUBd45n3rxo2 | inv-fauzan@dgc.com | investor |
| OVY8QdzPWwQGfEyqkbc4C3IxyOa2 | inv-muksal@krx.com | investor |
| WW6oHcaaG9W2ElWPHNlh15e6Gdx1 | adm-ilma@krx.com | admin |
| XYQo7MOXZRTFm29rTfpTLjXwEob2 | adm-center@dgc.com | admin |
| cbWwmhV0FGZxaJfqvUqOKBFIWCI2 | admin@krx.com | super_admin |
| kuC0VbY4ueghTAbCETVU6zbg46V2 | inv-wira@dgc.com | investor |
| yo3S2wc6bFOipR9dRu3T8Njvh4q1 | inv-mezz@dgc.com | investor |
| yu48olihYFMcMDJoL27tVSLapEX2 | inv-krx@dgc.com | investor |
